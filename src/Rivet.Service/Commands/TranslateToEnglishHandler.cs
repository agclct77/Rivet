...
/// <summary>
/// 翻譯成英文的指令處理器
/// 責任鏈中的一個具體處理器，負責將剪貼簿繁體中文內容翻譯成英文
/// </summary>
public class TranslateToEnglishHandler : CommandHandlerBase
{
